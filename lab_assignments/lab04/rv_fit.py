...
def fit_data(star,fitting_function):
    ...
    popt,pcov = curve_fit(fitting_function, star.t, star.vr, #FIX ME!, #FIX ME!,
    ...
    #return [[mp,mp_err,e,e_err,p,p_err,a,a_err], t_fit, vr_fit]
    return {"Mp":mp,"Mp_err":mp_err,"e": e, "e_err": e_err,"P":p, "P_err":p_err,"a":a, "a_err":a_err, "t_fit":t_fit, "vr_fit":vr_fit}
